...
describe('Page Hue', () => {
    ...
    it('should render the page correctly with all props and state data', () => {
        ...
        component.setState({ipaddress, connectData, lights, rooms});
    ...
    describe('Given the api requests fail', () => {
        ...
        let toastSpy, component, componentInstance, setStateSpy;

        beforeAll(() => {
            global.fetch = jest.fn().mockImplementation(() => Promise.resolve({ok: false, statusText: errorMessage}));
            toastSpy = jest.fn();
